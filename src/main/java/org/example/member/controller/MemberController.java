...
public interface MemberController {
    ...
    ModelAndView addMember(@RequestParam("kakaoImg") String img, @RequestParam("file") MultipartFile file, @RequestParam("userId") String userId, MemberDTO member, HttpServletRequest request) throws Exception;

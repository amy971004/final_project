...
<div id="backgroundImg">
    ...
    <div id="b1" style="display: none">
        ...
        <p><h1 style="padding-top: 18px; text-align: center"><i class="fa-solid fa-magnifying-glass fa-beat-fade"></i> Find Your ID</h1>
        <div id="b2">
            <form action="findById.do" method="post" id="findByIdForm" accept-charset="UTF-8">
                ...
                <p> <input type="button" value="Go" id="findByIdBtn" class="btn1">
            </form>
        </div>
    </div>
    ...
    <div id="c1" style="display:none;">
        ...
        <p><h1 style="padding-top: 18px; text-align: center"><i class="fa-solid fa-magnifying-glass fa-beat-fade"></i> Find Your PW</h1>
        <div id="c2">
            <form action="findByPw.do" method="post" id="findByPwForm" accept-charset="UTF-8">
                ...
                <p> <input type="button" value="Go" id="findByPwBtn" class="btn1">
            </form>
        </div>
    </div>
    ...
    <div id="d1" style="display: none;">
        ...
        <p><h1 style="padding-top: 18px; text-align: center"><i class="fa-solid fa-repeat fa-flip"></i> New PW</h1>
        <div id="d2">

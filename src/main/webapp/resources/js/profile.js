    ...
    $.ajax({
        ...
        success: function (data){
            ...
            for(let i =0; i<follow.length; i++){
                ...
                follow_article_content += "<a href='${contextPath}/main/profile/userProfile.do?userNickname=" + follow[i].userNickname + "'>";
    ...
    $.ajax({
        ...
        success: function (data){
            ...
            for(i =0; i<data.length; i++){
                let follow_article_content = "<div class='follow_article'>";
                follow_article_content += "<div class='follow_profile'>";
                follow_article_content += "<a href='${contextPath}/main/profile/userProfile.do?userNickname=" + follow[i].followUserId + "'>";
